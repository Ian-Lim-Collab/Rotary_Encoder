...
{
    encoder_A.rise(callback(this, &Rotary_Encoder::encoder_ISR_callback));
    encoder_A.fall(callback(this, &Rotary_Encoder::encoder_ISR_callback));
    encoder_B.rise(callback(this, &Rotary_Encoder::encoder_ISR_callback));
    encoder_B.fall(callback(this, &Rotary_Encoder::encoder_ISR_callback));
...
void Rotary_Encoder::encoder_ISR_callback(){
